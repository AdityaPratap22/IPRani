...
export const metadata = { title: "Services | IP Rani" };
  ...
  return (
    <>
              ...
              >
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-brand-blue transition-all duration-200 hover:gap-2.5 hover:text-brand-blue-dark"
                  >
      ...
      <section className="bg-bg-light-2 px-4 py-10 sm:px-6 lg:px-8">
        <Reveal className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-5 rounded-2xl border border-slate-200 bg-white p-8 transition-shadow duration-300 hover:shadow-lg sm:flex-row">
          ...
          <div className="flex shrink-0 flex-col items-stretch gap-3 sm:flex-row">
            <Link
              href="/contact-us"
              className="rounded-md bg-brand-blue px-6 py-3 text-center text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-blue-dark hover:shadow-lg"
            >
