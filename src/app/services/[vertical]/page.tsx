...
export async function generateMetadata({
  ...
  return {
    title: data ? `${data.name} Services` : "Services",
    description: data ? `Expert services for ${data.name}: ${data.description} Get comprehensive legal support from IP Rani.` : "Read about our services.",
  };
}
