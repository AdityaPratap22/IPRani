...
export const metadata = { title: "About Us | IP Rani" };
            ...
            {team.slice(0, 3).map((member, i) => (
              <Reveal key={member.slug} index={i}>
                <Link
                  ...
                  className="group block overflow-hidden rounded-2xl bg-white text-center shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
                >
