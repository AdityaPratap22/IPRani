...
export const metadata = {
  ...
  description: "Read the latest legal guides, industry insights, and compliance updates on intellectual property, trademarks, patents, and business laws in India.",
};
