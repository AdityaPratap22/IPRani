...
export const metadata = {
  title: "Case Studies",
  description: "Read real-world case studies of IP Rani protecting trademarks, resolving patent disputes, managing corporate legal compliance, and handling commercial litigation.",
};
